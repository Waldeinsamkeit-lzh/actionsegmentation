    ...
    <div style={{ padding: 20, fontFamily: "微软雅黑" }}>
      ...
      {videoUrl && (
        <div style={{ display: "flex", gap: 20, alignItems: "flex-start" }}>
          {/* 左侧：视频 + 时间轴 + 图例 */}
          <div style={{ flex: 1, minWidth: "400px", maxWidth: "50%" }}>
            ...
            {segments.length > 0 && (
              <>
                {/* 时间轴 */}
                <div style={{ position: "relative", height: 30, backgroundColor: "#eee", marginTop: 10 }}>
          ...
          {/* 右侧：表格 */}
          {segments.length > 0 && (
            <div style={{ flex: 1, overflowX: "auto", maxWidth: "50%" }}>
