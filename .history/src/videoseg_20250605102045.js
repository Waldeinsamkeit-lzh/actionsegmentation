    ...
    <div style={{ padding: 20, fontFamily: "微软雅黑" }}>
      ...
      {videoUrl && (
        <div style={{ display: "flex", gap: 20, alignItems: "flex-start" }}>
            ...
            <div style={{ flex: 1 }}>
            {/* 视频区域 */}
            <div style={{ width: "100%", backgroundColor: "#000", borderRadius: 6, overflow: "hidden" }}>
            ...
            {segments.length > 0 && (
                <>
                <div style={{ position: "relative", height: 30, backgroundColor: "#eee", marginTop: 10, borderRadius: 4 }}>
            ...
            {/* 右侧：表格 */}
            {segments.length > 0 && (
            <div style={{ flex: 1, background: "#fff", border: "1px solid #ddd", borderRadius: 6, padding: 12 }}>
                ...
                <tbody>
                    {segments.map((seg, idx) => (
                    <tr key={idx} style={{ textAlign: "center", borderBottom: "1px solid #ccc", height: 36 }}>
                        <td>{idx + 1}</td>
                        <td>{seg.labelText}</td>
                        <td>{seg.start}</td>
                        <td>{seg.end}</td>
